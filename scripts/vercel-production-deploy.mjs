...
const optionalRuntimeEnv = authMode === "oauth"
  ? ["MCP_ACCESS_TOKEN", "MCP_WRITE_PROPOSALS_ENABLED", "MCP_REMOTE_LOCAL_FS_ENABLED", "MCP_REMOTE_LOCAL_FS_REQUEST_TTL_SECONDS", "MCP_REMOTE_LOCAL_FS_WAIT_SECONDS", "MCP_REMOTE_LOCAL_FS_AGENT_FRESH_SECONDS", "OAUTH_JWKS_URL", "OAUTH_JWT_SECRET", "OAUTH_AUTH_PASSWORD"]
  : ["MCP_WRITE_PROPOSALS_ENABLED", "MCP_REMOTE_LOCAL_FS_ENABLED", "MCP_REMOTE_LOCAL_FS_REQUEST_TTL_SECONDS", "MCP_REMOTE_LOCAL_FS_WAIT_SECONDS", "MCP_REMOTE_LOCAL_FS_AGENT_FRESH_SECONDS"];
