...
function summaryFor(filePath) {
  const summaries = new Map([
    ...
    ["apps/obsidian-plugin/src/plugin-helpers.ts", "Plugin helper functions for readable sync summaries, setup guidance, client connection cards, and error messages."],
