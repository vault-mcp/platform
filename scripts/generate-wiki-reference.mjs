...
const authoredFiles = [
  ...
  "apps/obsidian-plugin/src/plugin-helpers.test.ts",
  "apps/obsidian-plugin/src/plugin-helpers.ts",
  ...
  "docs/deployment.md",
  "docs/self-host.md",
  "docs/releases/obsidian-plugin-0.1.0.md",
  ...
  "scripts/smoke-plugin-lifecycle.mjs",
  ...
  "scripts/smoke-postgres-fresh.mjs",
...
const sectionSummaries = [
  ...
  ["Migrations", "apps/server/src/migrations.ts", "Versioned Postgres schema setup for self-hosting and production deploys."],
  ...
  ["Plugin UX helpers", "apps/obsidian-plugin/src/plugin-helpers.ts", "Readable plugin-side server URL validation, sync summaries, and HTTP error guidance."],
  ...
  ["Plugin lifecycle", "scripts/smoke-plugin-lifecycle.mjs", "Private-alpha package gate that proves upgrade preserves settings and uninstall leaves vault notes intact."],
...
function summaryFor(filePath) {
  const summaries = new Map([
    ...
    ["apps/server/src/migrate.ts", "Command-line entrypoint for running Postgres migrations before deploys or upgrades."],
    ["apps/server/src/migrations.ts", "Versioned Postgres schema migrations and the migration runner used by startup and CLI."],
    ...
    ["apps/server/src/version.ts", "Public service name and version reported by the health endpoint."],
    ["apps/cli/src/index.ts", "CLI for building and optionally syncing the vault index."],
    ["apps/obsidian-plugin/src/plugin-helpers.ts", "Plugin helper functions for readable sync summaries and error messages."],
    ["docs/releases/obsidian-plugin-0.1.0.md", "Private-alpha release notes for the first Obsidian plugin package."],
    ["docs/self-host.md", "Private-alpha self-host guide covering env vars, migrations, Vercel, sync, smoke, clients, containers, upgrades, and recovery."],
    ["scripts/verify-obsidian-plugin-package.mjs", "Private-alpha package verifier that extracts the plugin zip into a disposable vault and checks runtime layout."],
    ["scripts/smoke-postgres-fresh.mjs", "Postgres fresh-boot smoke that migrates and verifies an isolated temporary schema."],
